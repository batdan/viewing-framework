...
class base
{
    ...
    protected $_autoload;                         // Chargement automatique ou non du tableau à l'affichage de la page
    ...
    protected $_jsAfterLoad;                      // Permet l'ajout de code JS au chargement du tableau
    ...
    protected function setOptions($options)
    {
        ...
        $this->_jsAfterLoad             = $options['jsAfterLoad'];
    ...
    protected function getHtml()
    {
        ...
        if ($this->_buttonCsv === true || ! empty($this->_title)) {
            ...
            if ($this->_buttonAdd === true || $this->_buttonCsv === true) {
                ...
                if ($this->_buttonCsv === true) {
                    ...
                    $buttonCsv->setAttribute('id', $this->_id . '_csv');
        ...
        foreach ($this->_fields as $field) {
            ...
            // Permet de passer une fonction JS (nom de la fonction) pour modifier les celulles d'une colonne
            $th->setAttribute('data-formatter', $optionsChamps['formatter']);
